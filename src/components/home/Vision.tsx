      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {goals.map((goal) => (
            <div
              key={goal.label}
              className="rounded-xl bg-white p-6 shadow-sm border border-warmgray-200 text-center"
            >
              <div className="text-3xl sm:text-4xl font-bold text-teal-700 mb-1">
                {goal.stat}
              </div>
              <div className="text-sm font-medium text-warmgray-500 uppercase tracking-wide mb-3">
                {goal.label}
              </div>
        ...
        <div className="mx-auto max-w-3xl">
          <div className="rounded-xl bg-teal-50 border border-teal-200 p-6 sm:p-8 text-center">
